...
def rnn_network(x_train,y_train,x_test,y_test):
    ...
    embedding_dim = 50     # Dimensión de los vectores de embedding
    hidden_units = 64      # Número de unidades en la capa oculta
    batch_size = 32        # Tamaño del lote (batch size)
    epochs = 10            # Número de epochs (iteraciones de entrenamiento)
